        ...
        <div class="header-body">
          ...
          <table width="100%">
            <tr>
              <td width="10%">
                @if($user->role_id == 9)
                <a href="/home3"><i style="font-size: 18px;font-weight: bold;color: black;" class="fa fa-chevron-left"></i></a>
                @else
            ...
            <tr>
              <td align="center" colspan="2">
                <img class="photos" src="/assets/img_banners/{{ $banner->photo }}" width="90%">
              </td>
            </tr>
          </table>
        ...
        <div class="col-xl-4 order-xl-2 mb-xl-0" style="padding-right: 0px;padding-left: 0px;padding-bottom: 0px;">
          <div class="card" style="border-radius: 2rem;border: 0px;">
            <div class="card-body" style="padding: 1rem; height: 100%">
              ...
              <div style="font-size: 16px;font-weight: bold;padding-top: 5px;">{{ $banner->judul }}</div>
              <div class="row">
