    ...
    <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
      <section class="container">
        <div class="ct-page-title" style="margin-bottom:0.5rem;">
          ...
          <div style="font-size:11px;">Masukan data-data berikut untuk reedem/ambil promo GRAB.</div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col" style="padding: 0px 0px 20px 0px;">
                ...
                <input type="text" class="form-control isi" id="kode" placeholder="Masukan Kode dari Grab">
                <br>
                <div class="row">
        ...
        $.ajax({
           ...
           success: function(data) {
            ...
            if(data.data == 0){
                ...
                swal("Kode Voucher Sudah Digunakan!", {
                   icon: "error",
                   buttons: false,
                   timer: 2000,
                });
                ...
                swal("Kode Voucher Sudah KADALUARSA!", {
                   icon: "error",
                   buttons: false,
                   timer: 2000,
                });
                ...
                swal("Kuota Voucher Sudah Habis!", {
                   icon: "error",
                   buttons: false,
                   timer: 2000,
                });
                ...
                setTimeout(function(){ window.location.href = '/promo/grab/transaksi?uuid='+data.uuid; }, 1500);
            }
