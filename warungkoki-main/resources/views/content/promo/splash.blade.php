...
<body>
        ...
        <div class="koperasi-login100" >
            <div class="wrap-login100 p-b-30">
                <div class="logo" align="center">
                    <img src="{{ asset ('assets/splash/images/xtom2.png') }}" width="70%" alt="AVATAR" align="center">
                </div>
                <span class="login100-form-title p-t-20 p-b-45"> 
                <input type="hidden" id="wilayah" value="{{ $wilayahid }}">            
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="logo" >
        <table width="100%">
            <tr>
                <td align="center">
                    <img src="{{ asset ('assets/splash/images/xtom2.png') }}" width="60%">
                    <input type="hidden" id="wilayah" value="{{ $wilayahid }}">
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        setTimeout(function(){ window.location.href = '/promos?wilayah='+wil; },3500);
