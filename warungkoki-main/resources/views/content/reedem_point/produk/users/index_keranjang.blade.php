...
<style type="text/css">
  ...
  <div class="main-content">
    ...
    <div class="container-fluid" style="margin-top: -14rem;">
      ...
      <div class="row">
        <div class="col">
            ...
            @php 
            $listNav = [
              [ 'id' => 'tabs-produk', 'href' => 'produk', 'active' => false, 'name' => 'Produk', 'order' => 0],
              [ 'id' => 'tabs-keranjang', 'href' => 'keranjang', 'active' => true, 'name' => 'Keranjang', 'order' => 1],
    ...
    <!-- ====== PRODUK ====== -->
    <div id="tabs-produk" role="tabpanel" aria-labelledby="tabs-history"></div>        

    <!-- ====== KERANJANG ====== -->
    @php 
    $saldopoint = $saldopoin ? $saldopoin->sisa : 0;
    @endphp
    @include('content.reedem_point.produk.users.partials.keranjang',['saldopoint'])
