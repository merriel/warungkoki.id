...
<style type="text/css">
  ...
  <div class="main-content">
                      ...
                      <table width="100%">
                        <tr>
                          ...
                          <td>
                            ...
                            <b style="font-size: 13px;">{{ $adasaldo ? $adasaldo->sisa : '0' }}</b>
                          </td>
      ...
      <div class="row">
        <div class="col">
            ...
            $listNav = [
              ...
              [ 'id' => 'tabs-history', 'href' => 'history', 'active' => true, 'name' => 'History', 'order' => 2],
            ];
            @endphp
    ...
    <!-- ====== PRODUK ====== -->
    <div id="tabs-produk" role="tabpanel" aria-labelledby="tabs-produk"></div>  

    <div id="tabs-keranjang" role="tabpanel" aria-labelledby="tabs-history"></div>   
    
    @include('content.reedem_point.produk.users.partials.history')
