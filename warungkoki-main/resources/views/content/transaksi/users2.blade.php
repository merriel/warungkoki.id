          ...
          <!-- <table width="100%">
            ...
            <div class="row">
              <div class="col-6" style="padding-right: 7.5px;">
                @if($tour->transaksi != 1)
                <div id="beli" class="card shadow-ss bg-iolo pop" onclick="Pembelian();" data-container="body" data-toggle="popover" data-color="success" data-placement="top" data-content="Lihat Transaksi Pembelian Anda disini">
                @else
                <div id="beli" class="card shadow-ss bg-iolo" onclick="Pembelian();">
                @endif
                  ...
                  <div class="card-body" style="padding-right: 13px; padding-left: 13px;">
                    <table width="100%">
                      <tr> 
                        ...
                        <td width="12px"></td>
                        <td align="right">
                          <i class="fas fa-handshake" id="iconreedem" style="color: #8a5d3b ;font-size: 32px;"></i>
                        </td>
                      </tr>
...
<!-- ===================REEDEM BIASA========================= --> 
              ...
              @else
                ...
                <a href="/users/transaksi/detail?uuid={{ $transaksout->uuid }}"><div class="card shadow-ss menusxx">
                    <div class="card-body">
                      <table width="100%" border="0">
                        <tr>
                          <td width="25%" rowspan="4">
