        ...
        <div class="col">
         <!--  <a href="/home"><button type="button" id="back" class='btn btn-sm btn-success'>Back</button></a> -->
            <div class="ct-page-title">
              <h1 class="ct-title" id="content">Input Pemasukan Barang</h1>
              <!-- <span class="badge badge-pill badge-default">Update Stok Terakhir : Doni Prasetyo (20 Oktober 2020 17:22)</span> -->
            </div>
            <input type="hidden" value="in" id="type">
            <input type="hidden" value="pemasukan" id="jenis">
            <hr>
            <div style="font-size: 12px;padding-bottom: 20px;"> Isilah Pemasukan Barang sesuai dengan barang yang datang ke toko Anda, pastikan Anda melakukannya dengan benar.</div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" align="center">
            <table border="0" align="center" width="100%">
                <tr><td>
                    <div style="font-size:18px;" class="text-warning"><b>KONFIRMASI PEMASUKAN?</b></div>
                    <input type="hidden" id="idready">
                </td></tr>
                <tr>
                    <td><div style="font-size:13px;">Apakah Anda yakin akan menyimpan Pemasukan ini?</div></td>
                </tr>
            </table>
            <hr>
            <div class="row">
