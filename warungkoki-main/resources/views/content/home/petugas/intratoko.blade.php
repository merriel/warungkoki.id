        ...
        <div class="col">
         <!--  <a href="/home"><button type="button" id="back" class='btn btn-sm btn-success'>Back</button></a> -->
            <div class="ct-page-title">
              <h1 class="ct-title" id="content">Input Kirim Barang</h1>
            ...
            <input type="hidden" value="intratoko" id="jenis">
            <hr>
            <label>Barang Mau di kirim kemana ?</label>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" align="center">
            <table border="0" align="center" width="100%">
                <tr><td>
                    <div style="font-size:18px;" class="text-warning"><b>KONFIRMASI PENGIRIMAN?</b></div>
                    <input type="hidden" id="idready">
                </td></tr>
                <tr>
                    <td><div style="font-size:13px;">Apakah Anda yakin akan Mengirim Barang-barang ini?</div></td>
                </tr>
            </table>
            <hr>
            <div class="row">
    ...
    function Yakin(){
      ...
      $.ajax({
        ...
        data: {
            ...
            'postid': postid,
            'qty': qty,
            'wilayahid': $('#wilayah').val(),
            },
        success: function(data) {

          swal({
              title: "Berhasil",
              text: "Barang Berhasil Terkirim!",
              icon: "success",
              buttons: false,
              timer: 2000,
          });
