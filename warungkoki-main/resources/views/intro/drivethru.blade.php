...
<body>
    <div class="limiter">
        <div class="splash-shell100" >
            <div class="wrap-login100 p-t-50 p-b-200">
                <div class="logo" id="img1" align="center" style="display: block;">
                    <br><br><br>
                    <img src="/assets/splash/images/shell.png" width="100%" alt="AVATAR" align="center"><br><br>
                    <input type="hidden" id="actions" value="{{ $aksi }}">
                ...
                <div class="logo" id="img2" align="center" style="display: none;">
                    ...
                    <div style="color: black;font-size: 21px;font-family: Montserrat-Bold;padding-bottom: 6px;"><b>DEALS & CHALLANGES</b></div>
                    <div style="color: black; font-size: 12px">Terdapat Deals & Challanges yang Menarik dan Lebih Murah</div>
                </div>
                <div class="logo" id="img3" align="center" style="display: none;">
                    ...
                    <div style="color: black;font-size: 21px;font-family: Montserrat-Bold;padding-bottom: 6px;"><b>MUDAH DIGUNAKAN</b></div>
                    <div style="color: black; font-size: 12px">Mudah dalam penggunaan, memiliki user interface yang menarik</div>
                </div>
                <div class="logo" id="img4" align="center" style="display: none;">
                    ...
                    <div style="color: black;font-size: 21px;font-family: Montserrat-Bold; padding-bottom: 6px;"><b>PEMBAYARAN MUDAH</b></div>
                    <div style="color: black; font-size: 12px">Pembayaran Mudah, ada banyak metode pembayaran yang dapat digunakan</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $('#selesai-submit').on('click', function () {
        ...
        var aksi = $('#actions').val();

         window.location.href = '/company/profile?id='+aksi+'';
