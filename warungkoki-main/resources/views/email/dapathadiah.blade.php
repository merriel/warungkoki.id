        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#d3e9f5" style="padding-top: 5px; padding-right: 24px; padding-left: 24px; padding-bottom: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 24px;">
              <p style="margin: 0;">Selamat Anda Mendapatkan reward dari X-Mission, berikut rincian reward mu : </p>
            </td>
          </tr>
          <!-- end copy -->
          <tr>
              ...
              <table width="100%" id="customers">
                ...
                <tr bgcolor="white">
                  <td colspan="2" style="font-size: 10px;" align="center">
                    <i>Ambil Reward Kamu di Jaringan TomXperience.id dari Tanggal <b>{{ date('d F Y', strtotime($mission->reward_dari)) }} - {{ date('d F Y', strtotime($mission->reward_sampai)) }}, Untuk Hadiah Mainan dan Voucher hanya bisa diambil di Shell Lippo Karawaci</b></i>
                  </td>
                </tr>
