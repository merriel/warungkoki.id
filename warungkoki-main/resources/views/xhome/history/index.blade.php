...
.nav__link2 {
  ...
  <div class="container-fluid pb-4 pt-md-8" style="padding-top: 4.8rem;">
    ...
    @else
      ...
      <a href="/xhome/history/detail?uuid={{ $trans->uuid }}"><div class="card shadow-ss menusxx">
          <div class="card-body">
            <table width="100%" border="0">
              <tr>
                <td width="25%" rowspan="4">
                  <div class="icon icon-shape bg-deliver text-white rounded-circle shadow-ss">
                  ...
                  <tr>
                    <td>
                      <div style="font-size: 13px;color: black;padding-bottom: 3px;">
                        <b>{{ date('d M Y', strtotime($trans->created_at)) }} | Rp. {{ $barang ?  number_format($barang->amount,0,',','.') : '' }}</b><br>
              ...
              <tr>
                <td>
                    @if($trans->status == "DIPROSES")
                      <span class="badge badge-info"><i class="fa fa-magic"></i> SEDANG DI PROSES</span>
                    @elseif($trans->status == "DELIVERY")
                      <span class="badge badge-info"><i class="fa fa-motorcycle"></i> &nbsp;DALAM PERJALANAN</span>
                    @else
