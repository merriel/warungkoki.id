@include('layout.head')
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-warung-3 pt-4 pt-md-8" style="padding-bottom: 14rem;">
          ...
          <div class="card shadow">
            <div class="card-body">
              <div style="padding-bottom: 16px;">
                ...
                <b>Rencana Pengiriman :</b>
                <br>
                <div class="text-success" style="padding-top: 5px;font-weight: bold;">{{ $trans->plan != NULL ? date('d F Y', strtotime($trans->plan)) : '-' }}</div>
                <hr>
                ...
                @if($potongan->amount == NULL)
                  <div class="card shadow-ss" style="margin-bottom: 6px;">
                    <div class="card-body">
                        <table width="100%">
                          <tr>
                            <td style="font-size: 11px;" width="65%"><b>POTONGAN {{ $potongan->percent }}%</b></td>
                            <td align="right"  style="font-size: 11px;"><b>- {{ rupiah($total* ($potongan->percent/100))  }}</b></td>
                          </tr>
                        </table>
                    </div>
                  </div>
                  ...
                  <div class="card shadow-ss" style="margin-bottom: 6px;">
                    <div class="card-body">
                        <table width="100%">
                          <tr>
                            <td style="font-size: 11px;" width="65%"><b>POTONGAN {{ $potongan->percent }}%</b></td>
                            <td align="right"  style="font-size: 11px;"><b>- {{ rupiah($potongan->amount)  }}</b></td>
                          </tr>
                        </table>
                    </div>
                  </div>
