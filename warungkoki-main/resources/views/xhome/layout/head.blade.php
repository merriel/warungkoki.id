...
<body class="">
  <nav style="position: fixed;top: 0;width: 100%;z-index: 100;" class="navbar navbar-vertical navbar-expand-md navbar-light bg-deliver" id="sidenav-main">
    <div class="container-fluid">
      <!-- Toggler -->
      {{ csrf_field() }}
      <a class="navbar-brand pt-0" href="/promo?wilayah=all" style="color: white; font-size: 18px;">
        <img src="/assets/splash/images/newtom2.png" class="navbar-brand-img" style="max-height: 2rem;"> &nbsp;&nbsp;| X-Delivery
      </a>
      @if(Auth::user() != null)
      ...
      <div align="right" id="usermenu" style="display: none;">
        ...
        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
          <a class="dropdown-item menusxx" href="/xhome/favorite">Favorite</a>
