        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-4">
              <div class="text-muted text-center mt-2 mb-3"><small>Login Menggunakan Akun Google Anda</small></div>
              ...
              <div role="form">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control login" id="username" placeholder="Email" type="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control login" id="password" placeholder="Password" type="password">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <table width="100%">
                      <tr>
                        <td><button type="button" id="logins" class="btn btn-iolo my-4">Login</button>
