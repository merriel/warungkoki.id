...
<body class="">
  <nav style="position: fixed;top: 0;width: 100%;z-index: 100;padding: 0.5rem 0rem 0rem 0rem;" class="navbar navbar-vertical navbar-expand-md navbar-light bg-warung" id="sidenav-main">
    <div class="container-fluid">
        ...
        <tr>
          <td width="15%" align="center">
            @if(Auth::user()->role_id == 4)
              <div id="pesanmenu">
                <span class="circlepesan"><b id="pesancount">0</b></span>
              </div>
              <a href="/messages" class="menusxx"><button class="navbar-toggler ">
          ...
          <td width="15%" align="center">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
              <a class="dropdown-item menusxx" href="/profile">Profil</a>
              <a class="dropdown-item menusxx" href="/alamatuser">Alamat Anda</a> 
              <a class="dropdown-item menusxx" href="/saldo/history">History Saldo Warungkoki</a>
              <a class="dropdown-item menusxx" href="/voucherundian">Voucher Undian</a>
              @if($ritel)
              <a class="dropdown-item menusxx" href="/retailer/admin">Masuk Sebagai Retailer</a>
              @endif
            </div>
      ...
      @if(Auth::user()->retailer_id == null)
      <!-- <table width="100%">    
        <tr>
          <td width="27%">&nbsp;</td>
          <td align="center" style="color:#172b4d; font-size:11px;">
            <div class="card shadow-ss" style="border-radius: 1rem;">
              <div class="card-body" style="padding: 5px 8px;" align="center">
               <img src="/assets/splash/images/topikoki.png" width="13%">&nbsp;&nbsp;By Topikoki Group
             </div>
            </div>
          </td>
          <td width="27%">&nbsp;</td>
      ...
      <div align="right" id="usermenu" style="display: none;">
        ...
        <!-- <a href="#">
          <button class="navbar-toggler" type="button" >
            <span style="color: white;" class="fa fa-bell"></span>
          </button>
        </a>
        ...
        <!-- <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
          ...
          <a class="dropdown-item menusxx" href="/users/transaksi">History Transaksi</a>
          <a class="dropdown-item menusxx" href="/saldo/history">History Saldo TOMX</a> -->
        <!-- </div> -->

        <!-- <a href="/keranjang" class="menusxx">
          <button class="navbar-toggler" type="button">
            <div style="padding-left: 10px;">
            <span class="circlekeranjang"><b id="keranjangcount"></b></span></div>
            <span style="color: white; font-size: 19px" class="ni ni-basket"></span>
          </button>
        </a>

        <button class="navbar-toggler" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span style="color: white;" class="ni ni-circle-08"></span>
        </button>
        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
            <a class="dropdown-item menusxx" href="/users/transaksi">My Transactions</a>
            <a class="dropdown-item menusxx" href="/favorite">Favorite</a>
            <a class="dropdown-item menusxx" href="/profile">My Profile</a>
      ...
      <!-- <div align="right" id="selainusermenu" style="display: none;">
      ...
      <div align="right" id="userpetugas" style="display: none;">
        ...
        <!-- <a href="/reedemtoday" class="menusxx">
          <button class="navbar-toggler" type="button" >
            <div style="padding-left: 10px;">
            <span class="circlenotif"><b id="notifreedem">0</b></span></div>
            <span style="color: white;" class="ni ni-bag-17"></span>
          </button>
        </a> -->
        ...
        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
            <a class="dropdown-item" href="/petugas/pengambilan?dari={{ date('Y-m-d') }}&sampai={{ date('Y-m-d') }}">List Penjualan</a>
            <a class="dropdown-item" href="#">Ganti Password</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="{{ route('logout') }}"
               onclick="event.preventDefault();
