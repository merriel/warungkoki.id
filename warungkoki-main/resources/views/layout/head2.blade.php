    ...
    <div class="container-fluid">
      ...
      <table width="100%">
        <tr>
          <td width="15%">&nbsp;</td>
          <td align="center">
            <img src="/assets/splash/images/koki.png" class="navbar-brand-img" style="max-height: 3.8rem;">
          </td>
      ...
      <table width="100%">
        ...
        <tr>
          <td bgcolor="#BAF713" style="font-size: 5px;">
             &nbsp;
          </td>
        </tr>
        <tr>
          <td bgcolor="#15BE77" style="font-size: 5px;">
             &nbsp;
          </td>
        </tr>
      </table>
