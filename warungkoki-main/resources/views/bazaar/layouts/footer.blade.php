...
<br><br><br>
<nav class="nav">
  <a href="/bazaar/home" class="nav__link menusxx">
    <div id="homes">
  ...
  <a href="/bazaar/keranjang" class="nav__link menusxx">
    <div id="keranjangmenu">
      <span class="circlekeranjang"><b id="keranjangcountbazaar">0</b></span>
    </div>
  ...
  <a href="/bazaar/transaksi" class="nav__link menusxx">
    <i class="fa fa-history" style="font-size: 18px;"></i>
    <span class="nav__text">
      <div style="font-size: 10px; padding-top: 8px;"><b>Transaksi Anda</b></div>
    </span>
  </a>
    ...
    if (role == '4'){
      ...
      $.ajax({
        ...
        success: function (data) {
          $('#keranjangcountbazaar').html(data);
