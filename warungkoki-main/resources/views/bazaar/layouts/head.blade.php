...
<body class="">
  <nav style="position: fixed;top: 0;width: 100%;z-index: 100;" class="navbar navbar-vertical navbar-expand-md navbar-light bg-bazaar" id="sidenav-main">
    <div class="container-fluid">
      <!-- Toggler -->
      {{ csrf_field() }}
      <a class="navbar-brand pt-0" href="/promo?wilayah=all" style="color: white; font-size: 18px;">
        <img src="/assets/splash/images/newtom2.png" class="navbar-brand-img" style="max-height: 2rem;"> &nbsp;&nbsp;| X-Bazzar
      </a>
      @if(Auth::user() != null)
