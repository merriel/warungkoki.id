      ...
      <div class="row">
        <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
          <div class="row justify-content-center">
              <h3 class="text-white">Claim Hadiah</h3>   
          </div>
          <br>
          ...
          <div class="card shadow">
            <div class="card-body">
              <div style="padding-bottom: 16px;">
                ...
                <br>
                <div style="padding-top: 5px;" class="text-warning"><b>{{ $saldo->hadiah_name }}</b></div>

                <hr>
                <b>Mission :</b>
                <br>
                <div style="padding-top: 5px;" class="text-warning"><b>{{ $saldo->mission_name }}</b></div>
          ...
          <button onclick="Claim({{ $saldo->reward_id }})" class="btn btn-success btn-block menusxx"> Claim Sekarang</button>
    ...
    $.ajax({
     ...
     success: function(data) {
        ...
        if(data == 0){
          ...
          swal({
              title: "Berhasil",
              text: "Anda berhasil Claim Hadiah ini!",
              icon: "success",
              buttons: false,
              timer: 2000,
          });
          ...
          setTimeout(function(){ window.location.href = '/home'; }, 1500);
            ...
            swal({
                title: "Berhasil",
                text: "Anda Sudah Claim Hadiah ini!",
                icon: "error",
                buttons: false,
                timer: 2000,
            });
